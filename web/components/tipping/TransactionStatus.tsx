...
interface TransactionStatusProps {
  ...
  // Warning when execute call failed (tip sent but not tracked)
  executeWarning?: string | null
  onDismissExecuteWarning?: () => void
}
  ...
  if (flowState === "delivering" && transaction) {
    ...
    return (
      <div style={{ width: "100%", textAlign: "center", padding: `${tokens.space.xl}px 0`, position: "relative" }}>
        ...
        {/* Execute warning banner — shown when tip was sent but DB tracking failed */}
        {executeWarning && (
          <div
            style={{
  ...
  if (flowState === "success" && transaction) {
    ...
    return (
      <div style={{ width: "100%", textAlign: "center", padding: `${tokens.space.lg}px 0` }}>
        ...
        {/* Execute warning banner — persists from delivering state if tracking failed */}
        {executeWarning && (
          <div
            style={{
              background: "rgba(245, 166, 35, 0.1)",
