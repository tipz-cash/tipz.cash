...
const statusConfig: Record<TipHistoryEntry["status"], { label: string; color: string; icon: string }> = {
          ...
          return (
            <div
              ...
              style={{
                ...
                borderBottom: i < Math.min(history.length, 3) - 1 ? "1px solid rgba(255, 255, 255, 0.04)" : "none",
              }}
            >
              <div style={{ display: "flex", alignItems: "center", gap: tokens.space.sm, minWidth: 0, flex: 1 }}>
                {/* Status indicator */}
                {cfg.icon === "check" && (
